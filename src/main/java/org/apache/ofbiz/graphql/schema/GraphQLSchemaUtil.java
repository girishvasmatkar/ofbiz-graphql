...
public class GraphQLSchemaUtil {
	...
	static {
		...
		fieldTypeGraphQLMap.put("text-indicator", "String");
		fieldTypeGraphQLMap.put("text-medium", "String");
		fieldTypeGraphQLMap.put("text-very-long", "String");
		fieldTypeGraphQLMap.put("time", "String");
		fieldTypeGraphQLMap.put("number-integer", "Int");
		fieldTypeGraphQLMap.put("fixed-point", "BigDecimal");
		fieldTypeGraphQLMap.put("currency-precise", "BigDecimal");
		fieldTypeGraphQLMap.put("id-long", "ID");
		fieldTypeGraphQLMap.put("text-short", "String");
		fieldTypeGraphQLMap.put("text-long", "String");
		...
		fieldTypeGraphQLMap.put("binary-very-long", "Byte");
